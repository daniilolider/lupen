...
from bot.routers.whitelist.user.user_commands_router import user_commands_router
from bot.routers.whitelist.user.user_texts_router import user_texts_router
